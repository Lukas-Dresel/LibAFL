...
impl<'de> Deserialize<'de> for VectorizedCoverage {
    fn deserialize<D>(_addeserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl VectorizedCoverage {
    pub fn from_element(input_length_exponent: usize, val: u16) -> Self {
        let mut array = [0u16; LANES];
        array[0] = val;
        Self {
    ...
    pub fn count_for_branch(&self, branch_index: usize) -> u16 {
